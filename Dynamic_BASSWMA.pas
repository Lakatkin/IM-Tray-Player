...
var
  ...
  BASS_WMA_StreamCreateFileAuth : function(mem:BOOL; fl:pointer; offset,length:QWORD; flags:DWORD; user,pass:PansiChar): HSTREAM; stdcall;
 // BASS_WMA_StreamCreateFileUser : function(flags:DWORD; proc:STREAMFILEPROC; user:DWORD): HSTREAM; stdcall;
  ...
  BASS_WMA_EncodeOpenFile : function(freq,chans,flags,bitrate:DWORD; fname:PansiChar): HWMENCODE; stdcall;
  ...
  BASS_WMA_EncodeOpenPublish : function(freq,chans,flags,bitrate:DWORD; url,user,pass:PansiChar): HWMENCODE; stdcall;
  BASS_WMA_EncodeOpenPublishMulti : function(freq,chans,flags:DWORD; bitrates:PDWORD; url,user,pass:PansiChar): HWMENCODE; stdcall;
  ...
  BASS_WMA_EncodeSetTag : function(handle:HWMENCODE; tag,text:PansiChar; ttype:DWORD): BOOL; stdcall;
