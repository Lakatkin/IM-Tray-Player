...
var
  ...
  BASS_MIDI_StreamCreateURL : function(URL:PChar; offset:DWORD; flags:DWORD; proc:DOWNLOADPROC; user:Pointer; freq:DWORD): HSTREAM; stdcall;
...
//  BASS_MIDI_StreamGetMarks : function(handle:HSTREAM; mtype:DWORD; var fonts:BASS_MIDI_MARK; count:DWORD): DWORD; stdcall;
  ...
  BASS_MIDI_FontGetPreset : function(handle:HSOUNDFONT; preset,bank:LongInt): PChar; stdcall;
  BASS_MIDI_FontCompact : function(handle:HSOUNDFONT): BOOL; stdcall;
  BASS_MIDI_FontPack : function(handle:HSOUNDFONT; outfile,encoder:PChar; flags:DWORD): BOOL; stdcall;
  BASS_MIDI_FontUnpack : function(handle:HSOUNDFONT; outfile:PChar; flags:DWORD): BOOL; stdcall;
