...
////////////////////////////////////////////////////////////////////
    ...
    // constructor
    constructor create(const key: widestring = ''); virtual;
  end;
...
const
  AudioGenie3DLL = 'Modules/Audiogenie3.dll';
...
function ConvertStringAComment(const pc: PWideChar): WideString;
begin
  result:=ConvertString(pc);
  // Refactor Alex
  // ïðîâåðÿåì ñòðîêó íà ïîòåíöèàëüíûé ìóñîð
  if pos('00',String(result))>0 then result:='';
end;
...
begin
  result := ConvertStringAComment(AG3AUDIOGetCommentW());
end;
